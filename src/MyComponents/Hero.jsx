  ...
  return (
    <div className='w-full bg-blue-500'>
        ...
        <div className='max-w-[1200px] text-center md:text-left mx-auto md:flex py-4 px-8 items-center justify-between'>
            ...
            <div className='space-y-4 md:space-y-14 w-[100%] md:w-[45%] lg:mb-20 flex flex-col items-center md:block p-6'>
                <div className='space-y-3 text-white'>
                    <h1 className='mb-3 text-4xl sm:text-5xl lg:text-7xl font-[700]'>Powerful Apps for Growth</h1>
            ...
            <div className='md:flex md:w-[50%] w-[100%] gap-16 space-y-5 md:space-y-0'>
                <div className='w-[130px] h-[250px] lg:w-full mx-auto'>
                ...
                <div className='space-y-10'>
                    <div className='text-white space-y-4'>
                        ...
                        <img src={HeroPerson} alt="" className='rounded-full w-14 h-14 mx-auto' />

                        <div className='font-bold text-xl flex space-x-2 justify-center'>
