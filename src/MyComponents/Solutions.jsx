        ...
        <div className='max-w-[1200px] text-center md:text-left mx-auto space-y-7 md:space-y-0 md:flex md:gap-6 lg:gap-14 xl:gap-20 py-4 px-8 items-center justify-between'>
            ...
            <div className='space-y-4 md:space-y-14 w-[100%] md:w-[45%] lg:mb-20 flex flex-col items-center md:block'>
                <div className=''>
                    ...
                    <p className='mb-3 md:text-[20px] text-[16px] font-[400]'>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
                </div>
                <div
                    // to="/SignUp"
                    // onMouseEnter={() => import('./SignUp.jsx')}
                    
                    className="bg-green-400 w-fit h-fit text-white rounded-full px-8 py-2 transition-all duration-300 transform hover:scale-105 flex items-center mx-auto md:mx-0 mt-2 md:mt-0"
                >
                    Read More
                </div>
            </div>
            
            <div className='md:flex md:w-[55%] w-[100%]'>
